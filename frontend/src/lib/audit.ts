...
export type AuditAction =
  ...
  | 'EMAIL_SENT' | 'MESSAGE_SENT' | 'WHATSAPP_SENT' | 'MESSAGE_DRAFT_CREATED' | 'MESSAGE_TRASHED' | 'EMAIL_DRAFT_CREATED' | 'EMAIL_TRASHED'
  | 'POST_CREATED' | 'POST_UPDATED' | 'POST_TRASHED' | 'POST_DELETED'
  | 'TRIP_VALIDATED' | 'TRIP_CANCELLED'
  | 'IA_DATA_INGESTION' | 'EXTERNAL_LEAD_INGESTED' | 'LOGIN_SUCCESS';
export type AuditEntity = 'USER' | 'MARKETING_EMAIL' | 'MARKETING_MESSAGE' | 'COMMUNICATION' | 'TRIP' | 'SYSTEM' | 'SITE_TRIP_REQUEST';
