...
# Charger les templates avec gestion d'erreurs
try:
    ...
    print(f"Erreur lors du chargement des templates admin: {e}")
    # Templates par défaut en cas d'erreur
    USER_FORM_TEMPLATE = "<div>Formulaire non disponible</div>"
    USER_TABLE_TEMPLATE = "<div>Tableau non disponible</div>"
    ADMIN_JS = "console.log('Admin JS non disponible');"
    ADMIN_LAYOUT = "<div>{{user_form}} {{user_table}}</div>"
